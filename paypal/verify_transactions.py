...
def balance():
    ...
    if(len(r.content) > 20):
        ...
        print(js['balances'][0]['total_balance']['value'])
        with open('balance.txt', 'w') as f:
            f.write(js['balances'][0]['total_balance']['value'])
...
def parse_content(c):
    ...
    for j in js:
        if 'transaction_info' in j:
            ...
            if status == 'S' and  amount > 0 and event != 'T0007' and event != 'T1501' and event != 'T1105' and event != 'T0300':
